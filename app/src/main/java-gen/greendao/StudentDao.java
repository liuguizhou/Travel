...
public class StudentDao extends AbstractDao<Student, Long> {
    ...
    public static class Properties {
        ...
        public final static Property FamilyAddress = new Property(5, String.class, "familyAddress", false, "FAMILY_ADDRESS");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"STUDENT\" (" + //
                ...
                "\"FAMILY_ADDRESS\" TEXT);"); // 5: familyAddress
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Student entity) {
        ...
        String familyAddress = entity.getFamilyAddress();
        if (familyAddress != null) {
            stmt.bindString(6, familyAddress);
        }
    }
    ...
    public Student readEntity(Cursor cursor, int offset) {
        Student entity = new Student( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5) // familyAddress
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Student entity, int offset) {
        ...
        entity.setFamilyAddress(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
     }
